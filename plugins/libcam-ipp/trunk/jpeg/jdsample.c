  ...
  JSAMPARRAY*          output_data_ptr)
{
  ...
  for(inrow = 0; inrow < cinfo->max_v_samp_factor; inrow++)
  {
    ...
    ippiSampleUpRowH2V1_Triangle_JPEG_8u_C1(inptr,compptr->downsampled_width,outptr);
  }
  ...
  JSAMPARRAY*          output_data_ptr)
{
  ...
  while(outrow < cinfo->max_v_samp_factor)
  {
    for(v = 0; v < 2; v++)
    {
      ...
      ippiSampleUpRowH2V2_Triangle_JPEG_8u_C1(inptr0,inptr1,compptr->downsampled_width,outptr);
    }
    inrow++;
  }
