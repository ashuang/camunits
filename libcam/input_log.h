...
#define CAM_INPUT_LOG_CONTROL_FRAME_ID 0
#define CAM_INPUT_LOG_CONTROL_PAUSE_ID 1
#define CAM_INPUT_LOG_CONTROL_ADVANCE_MODE_ID 2
#define CAM_INPUT_LOG_CONTROL_ADVANCE_SPEED_ID 3
